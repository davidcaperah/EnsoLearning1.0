...
<div className="bg-light pb-5" >
            ...
            <div className="container" >
                <div className="shadow rounded p-4 m-2" >
                    <p><span className="h6" > Tú curso: </span> {DatosCurso.Curso_Nu} </p>
                    <p><span className="h6" > Descripción: </span>  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi non quis exercitationem culpa nesciunt nihil aut nostrum explicabo reprehenderit optio amet. </p>
                    <p><span className="h6" > Número de estudiantes: </span> {DatosCurso.Can_Est} </p>
                    <p><span className="h6" > Nombre del docente: </span> Lucia Perez  </p>
                ...
                <div className="shadow rounded mt-5 p-3" >
                    ...
                    <div className="m-2 mt-5 " >   
                        {Estudiantes.map(Compa =>
                        <div className="d-flex justify-content-between" key={Compa.id}> 
