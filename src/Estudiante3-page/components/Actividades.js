    ...
    <div>
        ...
        <div>
                ...
                <div >
                    ...
                    <div className='cont-libro-actividad-estu1'>
                        ...
                        <div className='btn-libros-acti-estu1'>
                            <div className='btn-acti-lectura3'>Ver lectura</div>
                            <div className='btn-acti-biblioteca3'>ir a la biblioteca</div>
                        </div>
                    </div>
                </div>
            ...
            <div className='cont-acti-estu-1'>
                ...
                <div className='card-actividades-estu3' key={Acti.id}>
                    <div>
                        <div className='cont-titu-card-actividades'>
                            <h5>Aprendamos a multiplicar</h5>
                            <h6>Area de matematicas 202</h6>
                        </div>
                        <div>
                            <p>
                                Vencimiento <br/>
                    ...
                    <div className='card-cont-img-actividades3'>
                            <img src={`${URL.servidor}Archivos_u/iconos/matematicas.svg`}/>
                    </div>
                    <div className='btn-iniciar-acti-estu-3' onClick={()=> DesarrollarActividad(Acti) }>
                        Iniciar actividad
                    </div>
                </div>
                )}
                ...
                <div className="container pt-3 " >
                    ...
                    {ArregloDeActividades.map(Acti =>
                        ...
                        <div className="shadow p-3 m-2 w-50 m-auto" >
                            <h6 className="text-center"> <strong>¡Felicidades!</strong>, en el momento no cuentas con actividades pendientes! </h6>
                        </div>
                    }
                    </div>
