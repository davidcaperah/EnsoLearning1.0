...
const reducer = (state = initialState , action) => {
    const {type, user, numberInterfazGrados, numberInterfazPensamientos , Pensamientos , Tema , subTemas, Temas , numberInterfazActividades , subirActividad, docente, numberInterfazAula , aulaSeleccionada, cursosAdmin , interfazCursosAdmin, numberInterfazEstudiantes ,  datosEvaluacionEstudiantes, numberInterfazVerMallas , verMallasActividades , respuestaEvaluacion, planillasCurso, planillasEstudiante , idMallaSeleccionada, numberInterfazCurso,numberInterfazLibro, infoCoordi,TiempoEvaluacion,tiempoSalioEva, horasEvaluacion, MinutosEvaluacion, SegundosEvaluacion, CrearActividadDatos,CrearActividadDocente,RecursosImagen} = action
