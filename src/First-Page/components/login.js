      ...
      <div className="container pt-4">
        <div className="row shadow-lg rounded ">
          ...
          <div className="col-md-5 p-4">
            ...
            <form onSubmit={NoRecargar} noValidate autoComplete="off">
              <select className="mb-2 form-control" name="Estado" onChange={Escribir}>
              ...
              <input type="email" placeholder="Correo eléctronico" onChange={Escribir}className="mb-2 form-control" name="Email" minLength="1" maxLength="40" required pattern="[A-Za-z0-9--- -ñ-@-á-é-í-ó-ú]+"/>
              <input type="password" placeholder="Contraseña" className="form-control" name="Pass" autoComplete="on" onChange={Escribir} minLength="1" maxLength="40" required pattern="[A-Za-z0-9--- -ñ-@-á-é-í-ó-ú]+"/> 
