    ...
    e.preventDefault()
        ...
        if (Usuario.mensaje) {
          ...
          if(Usuario.id_m){
            ...
            let idmatEncry = CryptoJS.AES.encrypt(JSON.stringify(idmateria), 'A').toString();
            cookies.set('id1080M', idmatEncry, { path: "/", expires: new Date(Date.now() + 5 * 60 * 60 * 1000) });
          }
            ...
            <div className="row shadow-lg rounded " >
              ...
              <div className="col-md-5 p-4" >
                ...
                <div className="" >
                      ...
                      <a href="/Recuperar" class="stretched-link">Recuperala</a>
