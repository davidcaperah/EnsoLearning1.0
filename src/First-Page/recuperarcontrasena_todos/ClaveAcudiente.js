      ...
      <div className="container mt-5 mb-5">
        ...
        <div className="mt-5 m-auto">
          ...
          <p className="text-center bg-dark  text-white mt-5">
            Estimado <span className="font-weight-bold text-uppercase"> Acudiente </span>por favor ingresa el correo de la cuenta que desea recuperar la
            contraseña.
          </p>
