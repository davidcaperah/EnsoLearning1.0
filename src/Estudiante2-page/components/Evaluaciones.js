                            ...
                            <div className='datos-card-evaluacion-estu2'>
                                ...
                                <div>
                                    <div className='deco-img-card-estu2'>
                                        ...
                                        <img id="tornillo1-evalu-estu2" src={`${URL.servidor}Archivos_u/iconos/tornillo.svg`}/>
                                        <img id="tornillo2-evalu-estu2" src={`${URL.servidor}Archivos_u/iconos/tornillo.svg`}/>
                                        <img id="tornillo3-evalu-estu2" src={`${URL.servidor}Archivos_u/iconos/tornillo.svg`}/>
                                    </div>
                                </div>
                            </div>
                        </div>
