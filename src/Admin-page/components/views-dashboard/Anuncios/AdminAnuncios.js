    ...
    <div>
      ...
      {numeroInterfaz !== 0 ? (
        <div>
          ...
          {numeroInterfaz === 1 ? <AddAnuncios colegio={idSchool} /> : null}
          {numeroInterfaz === 2 ? (
            <EditAnuncios datosAnuncio={announcement} />
          ) : null}
        </div>
      ) : null}
    </div>
