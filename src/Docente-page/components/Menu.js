        ...
        <div className='menu' >
            <div className="list-group" >
                ...
                <li className="alert-primary-mio   btn-menu ">
                    ...
                    <a className="h6 alert-link-mio" href="/HomeDocentes"  > Home  </a>                      
                </li>

                <li className="alert-primary-mio   btn-menu ">  
                    <img src={`${URL.servidor}Archivos_u/iconos/icon-docentes.svg`}/>
                     <a className="h6 alert-link-mio" href="/DocenteDocentes" > Docentes  </a>

                </li>

                <li className="alert-primary-mio btn-menu ">  
                    <img src={`${URL.servidor}Archivos_u/iconos/icon-misaulas.svg`}/>
                    <a className="h6 alert-link-mio" href="/DocenteAulas" >   Mis Aulas   </a>  
                </li>
                ...
                <li className="alert-primary-mio btn-menu ">  
                    ...
                    <a className="h6 alert-link-mio" href="/DocenteCurso" >   Mi Curso   </a>  
                </li>


                <li className="alert-primary-mio  btn-menu  ">  
                    <img src={`${URL.servidor}Archivos_u/iconos/icon-estadisticas.svg`}/>
                    <a className="h6 alert-link-mio"  href="/DocenteEstadisticas" >  Estadísticas </a>  
                </li>

                <li className="alert-primary-mio  btn-menu  ">  
                    <img src={`${URL.servidor}Archivos_u/iconos/icon-evaluaciones.svg`}/>
                    <a className="h6 alert-link-mio"  href="/DocenteEvaluaciones" >  Evaluaciones </a>  
                </li>

                <li className="alert-primary-mio btn-menu  ">  
                    <img src={`${URL.servidor}Archivos_u/iconos/icon-actividades.svg`}/>
                    <a className="h6 alert-link-mio"  href="/DocenteActividades" >  Actividades </a>  
                </li>
            </div>
        </div>  
    );
