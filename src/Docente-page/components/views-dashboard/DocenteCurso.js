...
import Info from './Curso/info';
import Estudiantes from './Curso/Estudiantes.js';
import Publicaciones from './Curso/Publicaciones.js';
import { useSelector, useDispatch } from 'react-redux';
import EstadisticasStud from './Aulas/Planillas/estadisticasStud.js';
...
const DocenteCurso = () => {
    ...
    useEffect(() => {
        const sendData = async () => {
            ...
            const api = axios.create({ baseURL: URL.servidor });
            const response = await api.post('/api-php-react/Cargar_curpro.php', DatosJson);
                ...
                <div className='col-8' >
                    <div className='d-flex flex-column justify-content-end '>
                        <div className='cont-descri-mi-curso'>
                            En este espacio podras encontrar la informacion general que necesitaras como
                            director de curso horarios, planillas, agendas, observadores y mucho mas...
                        </div>
