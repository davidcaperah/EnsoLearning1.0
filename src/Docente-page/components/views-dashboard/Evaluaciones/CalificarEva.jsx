...
const Crear = () => {
  ...
  useEffect(() => {
        ...
        for (let llave in res){
          ...
          console.log("🚀 ~ file: CalificarEva.jsx:158 ~ .then ~ elemento", elemento)
          if(elemento.Tipo === 2){
            const element = pregutares;
            for (const key in element) {
                const respue = element[key];
                console.log("🚀 ~ file: CalificarEva.jsx:163 ~ .then ~ respue", respue)
          ...
          <div className="col-md-8 col-xs-8  flex-column d-flex justify-content-end ">
            <div className="d-flex flex-row justify-content-center">
              <div className="col-sm-12 col-md-3 col-xl-4 p-2 px-3 py-5 ">
                <h5
                  className={`opciones-evaluaciones ${vista === 0
                    ? "opcio-evalu-activa"
                    : "opcio-evalu-desacti"
                    }`}
                  onClick={() => setvista(0)}
              ...
              <div className="col-sm-12 col-md-3 col-xl-4 p-2 px-3 py-5  ">
                <h5
                  className={`opciones-evaluaciones ${vista === 1
                    ? "opcio-evalu-activa"
                    : "opcio-evalu-desacti"
                    }`}
                  onClick={() => setvista(1)}
                  ...
                  parseInt(evaluacion.estado) === 1 &&
                    ...
                    >
                      ...
                      <div className="cont-datos-evaluaciones">
                        ...
                        <button onClick={() => cargar(2, evaluacion)} className='btn btn-primary'>Calificar</button>
                        <div>
                        </div>
                        <div>
                        </div>
              ...
              {vista === 2 ?
                <div className='col-md-12'>
                  <table className="table table-striped">
                    ...
                    <tbody>
                      {respuestas ? respuestas.map(item =>
                        <tr>
                          <th scope="row">{item.Nombree} {item.Apellidoe}</th>
                          <td >
                            <span className='text-center pointer' title='Abrir Respuesta' onClick={() => cargar_respuesta(3, item)} >
                ...
                <div className='col-md-12'>
                  <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <div className='row'>
                        <div className='col-md-6'>
                          <strong> Preguntas Selección multiple: </strong> {respuesta.correctas} / {respuesta.calificadas}
                        </div>
                        <div className='col-md-6'>
                          <strong> Preguntas Abiertas: </strong> {respuesta.abiertas} En total
                        </div>
                      </div>
                      <div className='row'>
                        <div className='col-md-6'>
                          <strong> periodo: </strong> 
                          <select className="form-select" name="periodo" onChange={onChange}>
                      ...
                      <br />
                      <h5 className='text-center'><strong>Respuestas de preguntas abiertas</strong></h5>
                     {preguntas ? preguntas.map(pre =>
                     ...
                     <h5>error al cargar preguntas</h5>
                      ...
                      {respuesta.nota > 0  ?
                        <ul className="list-group list-group-flush text-center">
                            Ya se encuentra calificado la nota es <strong>{respuesta.nota}</strong>
                        </ul>:
                        <ul className="list-group list-group-flush">
                        <h2>Comentario</h2>
                        <textarea name='comentario' rows="5" cols="50" onChange={onChange}></textarea>
                        <br />
                        <button className='btn btn-primary' onClick={() => calificar(respuesta)}>Calificar</button>
                        </ul>
                        }
                    </div>
                  </div>
