...
const CreateActividades = () => {
    ...
    const data = useSelector(state => state.CrearActividadDatos)

    const siguiente = (dato) => {
        let interfaz
        dato ===1? interfaz = 11 : interfaz =  10
        if(dato === 1){
            interfaz = 11
            data.tipo_p = 1 ;
        }
        ...
        dispatch({
            ...
            CrearActividadDatos : data,
            actividad_hyg : false
        })
        
    }

    // cabiar el retrocedesr
          ...
          <div className="row" >
            ...
            <div className="row col-md-7" >
              <div className="col-md-6" >
                  <div className="shadow p-3 m-2 rounded Areas pointer" onClick={()=> siguiente(1) } >
              ...
              <div className="col-md-6" >
                  <div className="shadow p-3 m-2 rounded Areas pointer" onClick={()=> siguiente(2) } >
                    <div className="d-flex justify-content-center" >
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-file-earmark-text-fill" viewBox="0 0 16 16">
