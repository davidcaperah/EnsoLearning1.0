      ...
      {Validacion ? (
        <div className="row p-4">
          ...
          <div className="col-md-6">
            ...
            {Datos.publico === 1 ? (
              <p className="text-dark"> Ciclo Uno </p>
            ) : null}
            {Datos.publico === 2 ? (
              <p className="text-dark"> Ciclo Dos</p>
            ) : null}
            {Datos.publico === 3 ? (
            ...
            <button
              ...
              onClick={() => agregarLibroValidacion(Datos)}
            >
        ...
        <div className="m-2 p-3">
          <h1 className="text-center text-warning">
            ¡Califica este libro con estrellas!
          </h1>
          <p className="text-center text-white">
            Por favor seleccione con que cantidad de estrellas deseas calificar
            este libro sabiendo que las estrellas coloreadas darian el puntaje.
          </p>
          <div
            className="pointer"
            onClick={() => calificarLibro(0, true, "Eliminar")}
          >
            <svg
          ...
          <div className="row">
            <div className="col-md-4 text-center">
              {" "}
              <div
                className="pointer Areas shadow p-3 m-2"
                onClick={() => EnviarCalificacion(0)}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="25"
                  height="25"
                  fill="currentColor"
                  className="ml-2 text-warning bi bi-star"
                  viewBox="0 0 16 16"
                >
