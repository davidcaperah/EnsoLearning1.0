...
const DocenteEvaluaciones = () => {
    ...
    const cambiarEstado = async (b,id,eva) => {
        ...
        const response = await api.post('/api-php-react/Cargar_evaluacion_m.php', datosEnviar);
    ...
    return (  
        <div className='container-flex'>
                ...
                <div className='row contenedor-ecaluacion'>
                    ...
                    <div className='col-md-8 col-xs-8  flex-column d-flex justify-content-end '>
                        <div className="d-flex flex-row h-100 align-items-center justify-content-end mr-3 pr-5 mt-5 pt-5 ">
                            <div className='boton-evaluacion' onClick={crearEvaluacion}>+ Crear evaluacion</div> 
                        </div>
                        <div className="d-flex flex-row justify-content-center">
                            <div className='col-sm-12 col-md-3 col-xl-4 p-2 px-3 py-5 '>
                                <h5 className={`opciones-evaluaciones ${estadoEvalua ===0?"opcio-evalu-activa":"opcio-evalu-desacti"}`} onClick={evaluaEstado} >Evaluaciones Activas</h5>
                            </div>
                            <div className='col-sm-12 col-md-3 col-xl-4 p-2 px-3 py-5   '>
                                <h5 className={`opciones-evaluaciones ${estadoEvalua ===1?"opcio-evalu-activa":"opcio-evalu-desacti"}`} onClick={evaluaEstado} >Evaluaciones por asignar</h5>
                            </div>
                            <div className='col-sm-12 col-md-3 col-xl-4 p-2 px-3 py-5  '>
                                <h5 className={`opciones-evaluaciones ${estadoEvalua ===2?"opcio-evalu-activa":"opcio-evalu-desacti"}`} onClick={evaluaEstado}>Evaluaciones vencidas</h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='col-md-8 col-xl-8'>
                        ...
                        <div className='row'>
                            ...
                            DatosRecibidos.map(evaluacion =>
                                parseInt(evaluacion.estado) === 1 && parseInt(evaluacion.id_curso) !== 0?
                                <div className='cont-card-evaluacion col-3 ' key={evaluacion.id}>
                                    ...
                                    <div className='cont-datos-evaluaciones'>
                                        <div>
                                            ...
                                            <h4 className='overflow'>Descripcion: {evaluacion.texto} </h4>

                                        </div>
                                        <div>
                                            <p>
                                                Fecha de creacion <br/>
                                                {evaluacion.fecha_c}<br/>
                                        ...
                                        <div>{
                                            parseInt(evaluacion.estado) === 1 ? <div className="p-2" > <p> Estado : Activo </p>  </div> : 
                                            parseInt(evaluacion.estado) === 2 ? <div className=" p-2" > <p> Estado : Inactiva </p>  </div> : 
                                            parseInt(evaluacion.estado) === 0 ? <div className=" p-2" > <p> Estado : Inactiva </p>  </div> : null
                                            }
                                        </div>
                                        <div>
                                            <div className='btn-estado-evaluacion' onClick={()=>{cambiarEstado(evaluacion.id,evaluacion.estado)}}>
                                            {
                                            parseInt(evaluacion.estado) === 1 ?  "Inactiva"  : 
                                            parseInt(evaluacion.estado) === 2 ?  "Activo"  : 
                                            parseInt(evaluacion.estado) === 0 ?  "Activo" : null
                                            }
                                            </div> 
                                        </div> 
                                    </div>
                            ...
                            DatosRecibidos.map(evaluacion =>
                                ...
                                <div className='cont-card-evaluacion col-3 ' key={evaluacion.id}>
                                    <div className='d-flex flex-row'>
                                        <div className='estado-evaluaciones1'>Estado:Por asignar </div>
                                        <div className='con-ico-card-evaluaciones'> 
                                            <div onClick={() => eliminarEva(evaluacion)}>
                                                <img src={`${URL.servidor}Archivos_u/iconos/papelera-de-reciclaje.svg`}/>
                                            </div>                                                                               
                                         </div>
                                    </div>
                                    <div className='cont-datos-evaluaciones'>
                                        ...
                                        <div>
                                         ...
                                         <div><select name="cursos" id="cursos" onChange={gdato}>
                                        ...
                                        {
                                        <div>
                                        <div className='btn-estado-evaluacion' onClick={()=>{asingar_curso(evaluacion.id)}}>
                                            asignar
                                            </div> 
                                        </div>
                                }
                                ...
                                <div className='cont-card-evaluacion col-3 ' key={evaluacion.id}>
                                    ...
                                    <div className='cont-datos-evaluaciones'>
                                        ...
                                        <div>
                                         ...
                                         <div>
                                            <input type="date" name="fecha" id="fecha" onChange={grabar} />
                                         </div>
                                        {
                                        <div>
                                        <div className='btn-estado-evaluacion' onClick={()=>{cambiarEstado(this,evaluacion.id,evaluacion.estado)}}>
                                        {
                                            parseInt(evaluacion.estado) === 1 ?  "Inactiva"  : 
                                            parseInt(evaluacion.estado) === 2 ?  "Activar"  : 
                                            parseInt(evaluacion.estado) === 0 ?  "Activar" : null
                                            }
                                            </div> 
                                        </div>
                                }
            ...
            numeroInterfaz === 1 ? <Evaluaciones volver={volver}/>:null
            }
        </div> 
...
/*<div className="p-4" >
                ...
                <div>
                    {DatosRecibidos.length === 0 ?
                        <div className="shadow bg-white p-3 m-5 w-50 m-auto" >
                            <h6 className="text-center"> <strong>No haz realizado ninguna evaluación!</strong> </h6>
                        </div>
                        :
                        <div>
                            {DatosRecibidos.map(evaluacion =>
                                <div key={evaluacion.id} className="shadow rounded  bg-light p-3 m-2">
                                    <div onClick={() => editAct(evaluacion, 3)}>
                                        <h3> {evaluacion.Titulo} </h3>
                                        <p>  Texto: {evaluacion.texto} </p>
                                        <p>  Fecha de creación : {evaluacion.fecha_c} </p>
                                        <p> Fecha máxima de entrega : {evaluacion.fecha_max} </p>
                                        <p> Número de preguntas : {evaluacion.preguntas} </p>
                                    </div>
                                    {parseInt(evaluacion.estado) === 1 ? <div className="alert-success p-2" > <p> Estado : Activo </p>  </div> : null}
                                    {parseInt(evaluacion.estado) === 2 ? <div className="alert-warning p-2" > <p> Estado : Inactiva </p>  </div> : null}
                                    {parseInt(evaluacion.estado) === 0 ? <div className="alert-warning p-2" > <p> Estado : Inactiva </p>  </div> : null}
                                    {parseInt(evaluacion.estado) === 1 && <select className="form-control " name="estado" onChange={escritoenCampo}>
                                        <option unselectable="true" > Activo </option>
                                        <option value="1" > Activo </option>
                                        <option value="2" > Inactivo </option>
                                    </select>}
                                    {parseInt(evaluacion.estado) === 2 && <select className="form-control " name="estado" onChange={escritoenCampo}>
                                        <option unselectable="true" > Inactivo </option>
                                        <option value="1" > Activo </option>
                                        <option value="2" > Inactivo </option>
                                    </select>}
                                    {parseInt(evaluacion.estado) === 0 && <select className="form-control " name="estado" onChange={escritoenCampo}>
                                        <option unselectable="true" > Inactivo </option>
                                        <option value="1" > Activo </option>
                                        <option value="2" > Inactivo </option>
                                    </select>}
                                    <div className="col text-center p-4">
                                        <button className="btn btn-info" type="submit" onClick={() => cambiarEstado(evaluacion.id)}> Cambiar estado </button>
                                    </div>
                                    <div className="d-flex mt-2 justify-content-center" >
                                        <div>
                                            <div className="d-flex justify-content-center ml-2" >
                                                <div className="bg-danger rounded-circle pointer p-3  shadow-lg" onClick={() => eliminarEva(evaluacion)}>
            ...
            {numeroInterfaz !== 0 ?
                <div>
                    ...
                    {numeroInterfaz === 3 ? <CalifiacionEvaluacion Datos={datosEnviar} /> : null}
                </div>
                : null}
        </div>*/
