    ...
    <div>
      <div className="cont-mis-aulas-estudiante-1">
        ...
        <div className="descri-aulas-estu1">
          ...
          <p>
            Aqui podras encontrar todas las materias a las que asistes cada
            semana. !Mira tus notas parciales , actividades pendientes,
            evaluaciones y todo lo que aprenderás en este periodo.
          </p>
        </div>
      </div>
            ...
            <div id="svg-carpetas-img">
              ...
              >
                <g filter="url(#filter0_i_1179_2804)">
                  <path
                    d="M0.976685 38.9442L28.5694 1.99958L130.07 0.762025L151.477 37.1092L0.976685 38.9442Z"
                    fill="#868686"
                    fillOpacity="0.9"
                  />
                </g>
                <path
                  d="M129.502 1.76902L149.74 36.1304L2.98942 37.9196L29.0745 2.9935L129.502 1.76902Z"
                  stroke="#2F2F2F"
                  strokeOpacity="0.9"
                  strokeWidth="2"
                />
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      mode="normal"
                      in2="shape"
                      result="effect1_innerShadow_1179_2804"
                    />
                  </filter>
                </defs>
              </svg>
