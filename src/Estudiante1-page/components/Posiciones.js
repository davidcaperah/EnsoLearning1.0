...
const Posiciones = () => {
    ...
    return (
        <div className="container" >
            <div className="py-3" >
                <h3 className="text-center py-2 font-chewy text-warning" > Los mejores estudiantes de tu institución educativa </h3>
                ...
                {posiciones.map(Estu =>
                    <div className="shadow m-2 bg-light" key={Estu.id} >
                        <div className="row" >
                            <div className="col-md-4" >
                                <p className="text-center mt-3"  > {Estu.Nombre} </p>
                            </div>
                            <div className="col-md-4" >
                            <p className="text-center mt-3"  > {Estu.Curso} </p>
                            </div>
                            <div className="col-md-4" >
