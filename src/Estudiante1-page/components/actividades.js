...
function Actividades() {
    ...
    <div>
        ...
        <div className='cont-info-evaluaciones-estudiantes'>
            <div className='my-5' >  
                <div className='cont-img-estu1-aulas d-flex justify-content-center aling-items-center'>
                    <img alt="robot-ciclo1" src={`${URL.servidor}Archivos_u/iconos/astronauta.svg`} />
                 </div>
                <div id="circulo1-aulas-estu1" className='circulo-Actividades-estu1'></div>
                <div id="circulo2-aulas-estu1" className='circulo1-Actividades-estu1'></div>
            </div>
            <div className='informacion-evaluaciones-estu1'>
                <h4>Bienvenido a tus actividades</h4>
                <p>
                    en este espacio podras encontrar todas las actividades asignadas por tus
                    docentes para poner en practica tus conociminetos y adicionalemente encontraras 
        ...
        {ArregloDeActividades.map(Acti =>
            <div className='card-actividades-estu1' key={Acti.id}>
                <div>
