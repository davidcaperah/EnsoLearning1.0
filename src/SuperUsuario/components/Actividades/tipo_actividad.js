          ...
          <div className="row" >
            ...
            <div className="row col-md-7" >
              <div className="col-md-6" >
                  <div className="shadow p-3 m-2 rounded Areas pointer" onClick={()=> siguiente(6) } >
                    <div className="d-flex justify-content-center" >
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-question-diamond-fill" viewBox="0 0 16 16">
              ...
              <div className="col-md-6" >
                  <div className="shadow p-3 m-2 rounded Areas pointer" onClick={()=> siguiente(7) } >
                    <div className="d-flex justify-content-center" >
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-align-center" viewBox="0 0 16 16">
              ...
              <div className="col-md-6" >
                  <div className="shadow p-3 m-2 rounded Areas pointer" onClick={()=> siguiente(3) } >
                    <div className="d-flex justify-content-center" >
