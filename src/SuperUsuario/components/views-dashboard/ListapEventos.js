    ...
    return (
        ...
        <h3 className="text-center text-warning font-weight-bold">Descripción del evento</h3>
                <div >
                            <p>{datos.Nombre}</p>
                            <p>
                            Bienvenido al evento <strong className="text-warning">{datos.Nombre}</strong>
                            </p>
                            <p>
                            <strong className="text-warning">Descripción: </strong>{datos.des} 
                            </p>
                            <p>fecha fin <strong className="text-warning">{datos.fecha_f}</strong> y fue creada el dia <strong className="text-warning">{datos.fecha_i}</strong>.
                            </p>
                            <div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    DatosRecibidos.map((p)=>
                                        ...
                                        <td id={p.id} Value={p.result}>{p.result}</td>
                                        <td>{p.nombreC}</td>
                                        <td>
                                        <div className="d-flex align-items-center">
                                        <div className="d-flex justify-content-center ml-2" >
                                            <div className="bg-success rounded-circle pointer p-2  shadow-lg" onClick={() => Sumarp(p.id,p.result)}>
                                        ...
                                        <div className="d-flex align-items-center">
                                        <div className="d-flex justify-content-center ml-2" >
                                            <div className="bg-danger rounded-circle pointer p-2  shadow-lg" onClick={() => Restarp(p.id,p.result)} >
                                        ...
                                        <div className="d-flex align-items-center">
                                        <div className="d-flex justify-content-center ml-2" >
                                            <div className="bg-primary rounded-circle pointer p-2  shadow-lg" onClick={() => Guardarp(p.id,datos.id)} >
