...
const Menu = () => {
    ...
    useEffect(()  => {
        const TrearDatos = async () =>{
                ...
                const response = await api.post('/api-php-react/admin/Crud_admin.php', DatosJson);
                ...
                setNombres({Nombre:data.Nombre,Apellidos:data.Apellido,rol:data.rol,Tipo:data.Tipo})
        }
        TrearDatos();
    },[IdDoc,dispatch])
        ...
        <div>
            <div className="bg-purple p-3" >
                <div className="row" >
                    ...
                    <div className="col-9" >
                        <p className="text-light pt-2" > {Nombres.Nombre}  
                        <span className="h6" > <br />  {Nombres.Apellidos} </span>
                        <span className="h6" > <br /> {Nombres.rol}  </span> </p>
                    </div>
                </div>
            </div>
