            ...
            :
                <div>
                    <form onSubmit={addDerechos} >
                        <input type="text" className="form-control m-2" placeholder="Derechos Basicos de Aprendizaje" id="evidencia"  />
...
export default DerechosBasicos;